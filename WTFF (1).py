...
while True:
    #get SID
    urls = "https://hst-api.wialon.com/wialon/ajax.html?svc=token/login&params={\"token\":\"02cebc00b4e65ced484baf7fa287deb855CD944167EBD74A15354BB05176F3DA25A8ECF6\"}"
    ...
    params = {
        ...
        'params': '{"id":600074678,"flags":1024}',
        'sid': eid
    }
    ...
    if response.ok:
        ...
        if "road" in data.get("address", {}):
            ...
            print("No road information found in the response")
    ...
    for d in speed_limits:
        if d['name'] == street_name:
            maxspeed = d['maxspeed']
            print(f"The maxspeed for {street_name} is {maxspeed}")
            break
    else:
    ...
    if maxspeed != prev_value:
        ...
        prev_value = maxspeed
        print("same value,request not sent")
